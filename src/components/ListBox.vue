...
import { autoUpdate, offset, useFloating, shift, flip } from '@floating-ui/vue'
    ...
    <div class="relative mt-1">
      ...
      >
        ...
        <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
          <ChevronUpIcon
            class="h-5 w-5 text-gray-400 ui-open:transform ui-open:rotate-180"
            aria-hidden="true"
